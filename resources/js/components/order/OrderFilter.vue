            ...
            <form @submit.prevent="passes(submitForm)">
                <div class="filter">
                        ...
                        <div class="w-full">
                            <ValidationProvider name="paper.value.size" rules="required">
                                <div slot-scope="{ errors }">
                                    <multiselect class="customulti" v-model="paper.value.size" :options="paper.data.size"></multiselect>
                                    <p class="text-theme-red-light mt-1 px-1 text-sm font-medium">{{ errors[0] }}</p>
                                </div>
                            </ValidationProvider>
                            <div class="grid grid-cols-2 gap-3 mt-3" v-if="paper.value.size === 'custom size'">
                                <div>
                    ...
                    <div v-if="orderType === 'paper' "  class="flex items-center mb-5 input-wrapper">
                        ...
                        <div class="w-full">
                            <ValidationProvider name="paper.value.paper" rules="required">
                                <div slot-scope="{ errors }">
                                    <multiselect class="customulti" v-model="paper.value.paper" :options="paper.data.paper"></multiselect>
                                    <p class="text-theme-red-light mt-1 px-1 text-sm font-medium">{{ errors[0] }}</p>
                                </div>
                            </ValidationProvider>
                        </div>
                    ...
                    <div v-if="orderType === 'paper'" class="flex items-center mb-5 input-wrapper">
                        ...
                        <div class="w-full">
                            <ValidationProvider name="paper.value.color" rules="required">
                                <div slot-scope="{ errors }">
                                    <multiselect class="customulti" v-model="paper.value.color" :options="paper.data.color"></multiselect>
                                    <p class="text-theme-red-light mt-1 px-1 text-sm font-medium">{{ errors[0] }}</p>
                                </div>
                            </ValidationProvider>
                    ...
                    <div v-if="orderType === 'paper' "  class="flex items-center mb-5 input-wrapper">
                        ...
                        <div class="w-full">
                            <ValidationProvider name="paper.value.quantity" rules="required">
                                <div slot-scope="{ errors }">
                                    <multiselect class="customulti" v-model="paper.value.quantity" :options="paper.data.quantity"></multiselect>
                                    <p class="text-theme-red-light mt-1 px-1 text-sm font-medium">{{ errors[0] }}</p>
                                </div>
                            </ValidationProvider>
                    ...
                    <div class="flex items-center mb-5 input-wrapper">
                        ...
                        <div class="w-full">
                            <input type="text" class="p-2 w-full border focus:outline-none font-medium bg-white" v-model="general.data.turnaround" disabled >
                        </div>
                    </div>
                    <!-- input wrapper -->
                    <div class="flex items-center mt-12 input-wrapper">
                        <div class="w-full text-center ">
                            <span class="text-2xl font-medium text-gray-900 inline-block ml-4 text-theme-red-light">
                                Total:
                                <span>{{price}}AED</span>
                                Incl. VAT
                            </span>
    ...
    export default {
        ...
        data() {
            return {
                ...
                paper: {
                    ...
                    data: {
                        size: ["custom size","UAE (90x50) Standard", "EU (85x55) Standard", "Japan (91x55) Standard"],
                        paper: ["400 gsm matt laminated"],
                        color: ["Two sides colours","one side color"],
                        quantity: ["250 copies", "500 copies", "750 copies", "1000 copies", "2000 copies"],
        ...
        computed: {
            ...
            notSelectedPaperFinishing () {
                ...
                return _.difference(this.paper.data.finishing,selected);
            },
        ...
        methods: {
            ...
            submitForm: function () {
                if(this.orderType === 'shirt' && !this.isShirtSizes){
                    this.isShirtSizesError = true
                }else{
                    alert ("done")
                }
