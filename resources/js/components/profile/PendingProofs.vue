<template>
    <div>
        <div class="text-2xl font-semibold text-gray-900 flex items-center justify-between">
            ...
            <span>
                <input type="search" placeholder="Search Order Number/Products/Name " class="rounded w-full md:w-25rem text-base p-2 focus:outline-none border">
            </span>
        </div>
        ...
        <div class="mt-10">
            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                ...
                <div class="border overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    ...
                    <div class="text-center font-medium text-lg my-12">No Results Found! You have no order.</div>
                </div>
                </div>
            </div>
            </div>
