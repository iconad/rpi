...
<tr>
<td style="padding-bottom: 20px; background-color: #ffffff;" valign="top"><strong>Dear {{$data['name']}} ,</strong>
    <br />
    <br />
    {!! $data['message'] !!} </td>
<tr>
    ...
    <td>
        <table width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
            ...
            <tr>
                ...
                <div>
                    <a style="background-color: #008000; color: #ffffff; display: inline-block; font-family: sans-serif; font-size: 18px; line-height: 40px; text-align: center; text-decoration: none; width: 200px; -webkit-text-size-adjust: none;" href="{{$data['link']}}">Pending Proof Link</a>
                </div>
                </td>
