                ...
                <header class="bg-white shadow-lg hidden md:block">
                    ...
                    <nav class="bg-white text-black py-4 px-14 md:px-15 flex justify-between items-center">
                        <div class="flex items-center md:ml-4">
                            <!-- Add your logo here -->
                            <a href="https://printo.ae/"><img src="{{ asset('images/home/logo.png') }}" alt="Printo" class="h-16 w-30"></a>
                        </div>
                        ...
                        <ul id="mobile-menu" class="hidden md:flex space-x-6 flex-nowrap pl-4 pr-2">
                            ...
                            <li><a href="https://printo.ae/categories/print-products" class="text-gray-800 hover:text-gray-600">Printing</a></li>
                            <li><a href="https://printo.ae/categories/packaging" class="text-gray-800 hover:text-gray-600">Packaging</a></li>
                            <li><a href="https://printo.ae/categories/banners-displays" class="text-gray-800 hover:text-gray-600">Banners & Displays</a></li>
                            <li><a href="https://printo.ae/comingsoon" class="text-gray-800 hover:text-gray-600">Merch</a></li>
                            <li><a href="https://printo.ae/comingsoon" class="text-gray-800 hover:text-gray-600">Corporate</a></li>
                            <li><a href="https://printo.ae/categories/wallpapers" class="text-gray-800 hover:text-gray-600">Wallpapers</a></li>
