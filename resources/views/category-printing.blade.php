...
<section class="toppicks md:p-5 p-4 md:px-14">
    ...
    <div class="bg-white p-0 md:p-4 mt-4">
        <h1 class="text-4xl md:text-5xl mb-3 md:mb-6">Printing.</h1>
    ...
    <div class="mt-8 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div class="bg-white p-0 md:p-4">
            ...
            <a href="">
                <h2 class="md:text-lg text-xs mt-3 md:mt-6">Business cards</h2>
            </a>
        </div>
        ...
        <div class="bg-white p-0 md:p-4">
            ...
            <a href="">
                <h2 class="md:text-lg text-xs mt-3 md:mt-6">Envelopes</h2>
            </a>
        </div>
