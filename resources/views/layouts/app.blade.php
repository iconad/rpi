...
<body>
    <div class="px-3 sm:px-6 md:px-12 xl:px-0 md:max-w-screen-xl mx-auto" id="app">
        ...
        <a href="https://api.whatsapp.com/send?phone=971562876500&text=Iam intreasted in printo Services" class="float"
            target="_blank">
