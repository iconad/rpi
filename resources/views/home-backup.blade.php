        ...
        <section class="relative overflow-x-hidden">
            <div class="swiper-container swiper-container-printo h-96 ">
                <div class="swiper-wrapper ">
                    <div class="swiper-slide relative hidden md:block slidehidemobile">
                    ...
                    <!-- Mobile Slides Only -->
                    <div class="swiper-slide relative  hidden md:block slidehidedesktop ">
                        <img src="{{ asset('images/home/slider/slidem1.jpg') }}" alt="WEAR YOUR IMMAGINATION "
                            class="slide-image ">

                    </div>
                    <div class="swiper-slide relative  hidden md:block slidehidedesktop ">
                        <img src="{{ asset('images/home/slider/slidem2.jpg') }}" alt="Image " class="slide-image ">

                    </div>
                    <div class="swiper-slide relative  hidden md:block slidehidedesktop ">
                        <img src="{{ asset('images/home/slider/slidem3.jpg') }}" alt="Image " class="slide-image ">

                    </div>
                    <div class="swiper-slide relative  hidden md:block slidehidedesktop ">
                        <img src="{{ asset('images/home/slider/slidem4.jpg') }}" alt="Image " class="slide-image ">

                    </div>
                    <div class="swiper-slide relative  hidden md:block slidehidedesktop ">
                        <img src="{{ asset('images/home/slider/slidem5.jpg') }}" alt="Image " class="slide-image ">

                    </div>
                    <div class="swiper-slide relative  hidden md:block slidehidedesktop ">
                        <img src="{{ asset('images/home/slider/slidem6.jpg') }}" alt="Image " class="slide-image ">
    ...
    <section class="whatsappbanner relative px-4 md:px-0 py-8 md:py-16">
        <div class="h-auto text-white relative">
            <img src="{{ asset('images/home/whatsapp.jpg') }}" alt="whatsapp"
                class="mobilewhatsappimage w-full max-w-sm mb-8 md:max-w-none md:mb-0">
    ...
    <section class="p-8 md:p-16 newitems">
        ...
        <div class="grid grid-cols-1 grid-cols-2 md:grid-cols-4 gap-0 md:gap-6">
            <div class="p-2 flex flex-col md:items-center">
                ...
                <p class="newitemsbox-price text-xs mdtext-lg text-dark-gray">AED 39.00</p>
                <p class="box-info text-light-gray mb-2">On size | No minimums</p>
