...
<body class="overflow-x-hidden bg-white">
    <div class="container mx-auto max-w-full">
        ...
        <section class="p-5 md:px-12 bestseller">
            <h2 class="text-4xl mb-4 py-10 md:py-16">Best Sellers</h2>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-16">
                <!-- Box 1 -->
                <div class="relative box">
                    <a href="#"><img src="{{ asset('images/home/product1.jpg') }}" alt="Product 1" class="box-image"></a>
                ...
                <!-- Box 5 -->
                <div class="relative box">
                    <a href="#"><img src="{{ asset('images/home/product5.jpg') }}" alt="Product 5" class="box-image"></a>
                    <div class="flex items-center justify-between mb-2 md:pt-6 pt-0.5">
                ...
                <!-- Box 6 -->
                <div class="relative box">
                    <a href="#"><img src="{{ asset('images/home/product6.jpg') }}" alt="Product 6" class="box-image"></a>
                    <div class="flex items-center justify-between mb-2 md:pt-6 pt-0.5">
                ...
                <!-- Box 7 -->
                <div class="relative box">
                    <a href="#"><img src="{{ asset('images/home/product7.jpg') }}" alt="Product 7" class="box-image"></a>
                    <div class="flex items-center justify-between mb-2 md:pt-6 pt-0.5">
                ...
                <!-- Box 8 -->
                <div class="relative box">
                    <a href="#"><img src="{{ asset('images/home/product8.jpg') }}" alt="Product 8" class="box-image"></a>
                    <div class="flex items-center justify-between mb-2 md:pt-6 pt-0.5">
                ...
                <!-- Box 9 -->
                <div class="relative box">
                    <a href="#"><img src="{{ asset('images/home/product9.jpg') }}" alt="Product 9" class="box-image"></a>
                    <div class="flex items-center justify-between mb-2 md:pt-6 pt-0.5">
        ...
        <section class="toppicks p-5 md:px-12">
            <h2 class="text-4xl mb-6 py-10 md:py-16">Top Picks</h2>
        ...
        <div class="text-4xl mb-4 pt-10 md:pt-0 py-4 ml-8 md:ml-12">Hot Items</div>


        <section class="flex flex-col md:flex-row p-9 md:p-12">
        ...
        <section class="customerreviews">
            ...
            <section class="reviews-container">
                <div class="reviews-title text-4xl mb-4 ml-10 md:ml-12 py-8 mb-12">Hear From Our Customers</div>
                <div class="slider-container mobilereviews">
                    <div class="custom-swiper-container swiper-container">
                        <div class="swiper-wrapper ml-10 md:ml-12">
    ...
    <section class="whatsappbanner relative px-4 md:px-0 py-8 md:py-16">
        <div class="h-auto text-white relative">
            <img src="{{ asset('images/home/whatsapp.jpg') }}" alt="whatsapp" class="mobilewhatsappimage w-full max-w-sm mb-8 md:max-w-none md:mb-0">
    ...
    <section class="flex flex-col md:flex-row p-6 md:p-16">
        <!-- Left Side Content -->
        <div class="md:w-1/2 px-4 md:px-6 pt-0 md:pt-24">
            <h2 class="text-2xl md:text-6xl mb-4">Let's Talk Branding</h2>
            <p class="text-black text-1xl md:text-1-4rem ml-1">
    ...
    <section class="p-8 md:p-16 newitems">
        ...
        <div class="grid grid-cols-1 grid-cols-2 md:grid-cols-4 gap-0 md:gap-6">
            <div class="p-2 flex flex-col md:items-center">
                ...
                <p class="md:text-center text-xs md:text-lg font-semibold text-black pt-2 md:pt-6">Tshirts</p>
                <p class="newitemsbox-price text-xs md:text-lg text-dark-gray">AED 39.00</p>
                <p class="box-info text-light-gray mb-2">On size | No minimums</p>
            ...
            <div class="p-2 flex flex-col md:items-center">
                ...
                <p class="md:text-center text-xs md:text-lg font-semibold text-black pt-2 md:pt-6">Cups & Mugs</p>
                <p class="newitemsbox-price text-xs md:text-lg text-dark-gray">AED 39.00</p>
                <p class="box-info text-light-gray mb-2">On size | No minimums</p>
                <div class="whatsapp-button newitemswhatsapp">
                    <a href="whatsapp-link-1" class="whatsapp-icon">
            ...
            <div class="p-2 flex flex-col md:items-center">
                ...
                <p class="md:text-center text-xs md:text-lg font-semibold text-black pt-2 md:pt-6">Mousepads</p>
                <p class="newitemsbox-price text-xs md:text-lg text-dark-gray">AED 39.00</p>
                <p class="box-info text-light-gray mb-2">On size | No minimums</p>
                <div class="whatsapp-button newitemswhatsapp">
                    <a href="whatsapp-link-1" class="whatsapp-icon">
            ...
            <div class="p-2 flex flex-col md:items-center">
                ...
                <p class="md:text-center text-xs md:text-lg font-semibold text-black pt-2 md:pt-6">Powerbanks</p>
                <p class="newitemsbox-price text-xs md:text-lg text-dark-gray">AED 39.00</p>
                <p class="box-info text-light-gray mb-2">On size | No minimums</p>
                <div class="whatsapp-button newitemswhatsapp">
                    <a href="whatsapp-link-1" class="whatsapp-icon">
    ...
    <script>
        var swiper = new Swiper('.custom-swiper-container', {
            slidesPerView: 1.6, // Show 3 slides on desktop
            spaceBetween: 16,
            loop: true,
            autoplay: {
                delay: 3000,
    ...
    <script>
        var companyLogoSwiper = new Swiper('.companylogo-carousel', {
            ...
            breakpoints: {
                ...
                640: {
                    slidesPerView: 5, // Show 3 slides per view on mobile
                    spaceBetween: 14, // Adjust spacing as needed
                },
                // You can add more breakpoints for other screen sizes if needed
            },
        });
    </script>
