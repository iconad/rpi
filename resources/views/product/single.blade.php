...
@section('content')
    ...
    <section class="product-size-specifications my-16" id="specifications">
        ...
        <div class="sizess mt-5 bg-theme-gray p-8">
            <div class="text-2xl flex items-center font-semibold text-gray-800 mb-5">
                ...
                <span>Sizes <span class="font-normal">(in mm)</span></span>
            </div>
            {{-- header --}}
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-10">
                <div class="box border border-primary">
                    ...
                    <div class="flex items-center justify-around p-5 bg-white h-64">
                        ...
                        <div class="w-full">
                            <img class="mx-auto" src="https://www.printarabia.ae/img/products/details/specs/size/business_cards/vertical-90x50mm.png?s=webp" alt="image">
                        </div>
                    </div>
                </div>
                {{-- box --}}
            ...
            <div class="mt-8">
                <a class="text-primary font-semibold text-xl border-b border-transparent hover:border-primary " href="http://">Download Templates</a>
            </div>
        </div>
        {{-- prices dropdonw --}}
    </section>
    ...
    <section class="quantity-section my-16 p-6">
        <div class="flex flex-wrap lg:flex-no-wrap items-center">
            <div class="w-full mb-5 lg:mb-0 text-2xl font-semibold text-gray-900 flex items-center">
                <span class="text-gray-600 inline-block mr-2">
                    <svg class="fill-current w-8 h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"><path d="M2 2c0-1.1.9-2 2-2h12a2 2 0 012 2v16a2 2 0 01-2 2H4a2 2 0 01-2-2V2zm3 1v2h10V3H5zm0 4v2h2V7H5zm4 0v2h2V7H9zm4 0v2h2V7h-2zm-8 4v2h2v-2H5zm4 0v2h2v-2H9zm4 0v6h2v-6h-2zm-8 4v2h2v-2H5zm4 0v2h2v-2H9z"/></svg>
                </span>
                <span>
                    Quantity
                </span>
            ...
            <div class="text-3xl font-semibold text-gray-900 ml-0 md:ml-6 w-full mt-5">
                <product-quality-chart></product-quality-chart>
            </div>
        </div>
    </section>
    {{-- price and page section ended here --}}
    ...
    <section class="printing-section my-16 bg-theme-gray p-6">
        <div class="flex flex-wrap lg:flex-no-wrap items-center">
            ...
            <div class="text-xl font-medium text-gray-900 ml-0 md:ml-16 w-full">
                <ul>
                    <li>
                        <p>CMYK full colour. Double sided or single sided printing.</p>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="flex flex-wrap lg:flex-no-wrap items-start">
            ...
            <div class="text-xl font-medium text-gray-900 ml-0 md:ml-16 w-full">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5 md:gap-10">
                    <div class="box">
                        <div class="text-2xl font-semibold text-primary mb-4">Hot Foil</div>
                        <p class="text-base">Get fancy with foils. Add a beautiful metallic gold foil to your design and turn up the WOW factor. Choose from one or
                            bothsides.</p>
                        <p class="my-4 text-lg text-sec font-semibold">+1 Working Day</p>
                    ...
                    <div class="box">
                        <div class="text-2xl font-semibold text-primary mb-4">Emboss</div>
                        <p class="text-base">Get fancy with foils. Add a beautiful metallic gold foil to your design and turn up the WOW factor. Choose from one or
                            bothsides.</p>
                        <p class="my-4 text-lg text-sec font-semibold">+2 Working Day</p>
                        <a href="#" class="block relative h-48">
                            <img class="absolute left-0 top-0" src="https://i1.ytimg.com/vi/cLv07w6noGM/maxresdefault.jpg" alt="youtbe thumbnail">
                            <span class="absolute left-0 top-0 z-10 text-youtube w-full h-full flex items-center justify-center">
                                <svg class="fill-current w-16 h-16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M23 6a3 3 0 00-2-2h-9-9a3 3 0 00-2 2 31 31 0 00-1 6 31 31 0 001 6 3 3 0 002 2h18a3 3 0 002-2 31 31 0 001-6 31 31 0 00-1-6zM10 16V8l6 4z"/></svg>
                            </span>
                        </a>
                    ...
                    <div class="box">
                        <div class="text-2xl font-semibold text-primary mb-4">Punch Hole</div>
                        <p class="text-base">Get fancy with foils. Add a beautiful metallic gold foil to your design and turn up the WOW factor. Choose from one or
                            bothsides.</p>
                        <p class="my-4 text-lg text-sec font-semibold">+1 Working Day</p>
                    </div>
                    ...
                    <div class="box">
                        <div class="text-2xl font-semibold text-primary mb-4">Round Corner</div>
                        <p class="text-base">Get fancy with foils. Add a beautiful metallic gold foil to your design and turn up the WOW factor. Choose from one or
                            bothsides.</p>
                        <p class="my-4 text-lg text-sec font-semibold">+1 Working Day</p>
                        <a href="#" class="block relative h-48">
                            <img class="absolute left-0 top-0" src="https://i1.ytimg.com/vi/dA4WhY19cs8/maxresdefault.jpg" alt="youtbe thumbnail">
                            <span class="absolute left-0 top-0 z-10 text-youtube w-full h-full flex items-center justify-center">
                                <svg class="fill-current w-16 h-16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="M23 6a3 3 0 00-2-2h-9-9a3 3 0 00-2 2 31 31 0 00-1 6 31 31 0 001 6 3 3 0 002 2h18a3 3 0 002-2 31 31 0 001-6 31 31 0 00-1-6zM10 16V8l6 4z"/></svg>
                            </span>
                        </a>
    ...
    <section class="turnaround-page my-16" id="turnaround">
        <div class="text-center w-full md:w-2/3 mx-auto">
            ...
            <p class="text-xl text-gray-800">2 Business Days (not included Fri, Sat & Holidays)</p>
    ...
    <section class="warning my-12 md:my-24">
        <div class="w-4/5 mx-auto text-center text-xl">
            <p> <span class="inline-block mr-2">
                <svg class="w-8 h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 23.6 20.1"><path d="M23 18L12 1a1 1 0 00-1 0L1 18a1 1 0 000 1 1 1 0 000 1h21a1 1 0 001-1 1 1 0 000-1z" fill="#ffd900" stroke="#231916" stroke-miterlimit="10" stroke-width="1.2"/><path d="M11 12V9 7a2 2 0 010-1 1 1 0 011-1 1 1 0 011 1 3 3 0 010 1v5a3 3 0 01-1 2 1 1 0 01-1 0 4 4 0 010-2zm1 6a1 1 0 01-1-1 1 1 0 010-1 1 1 0 011-1 1 1 0 011 1 1 1 0 010 1 1 1 0 01-1 1z" fill="#231916"/></svg>
            </span>
