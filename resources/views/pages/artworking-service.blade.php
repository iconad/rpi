...
<section class="pages-wrapper my-10">
    ...
    <div class="mt-12">
        ...
        <div class="flex flex-wrap md:flex-no-wrap mt-16">
        ...
        <div class="border p-10 mt-10 border-gray-500 relative">
            ...
            <div class="flex flex-wrap md:flex-no-wrap">
                ...
                <div class="w-full md:pl-12">
                    <div class="text-primary font-semibold text-xl">We accept editable files in these formats:</div>
                    ...
                    <div class="flex flex-wrap md:flex-no-wrap justify-center items-center">
                        ...
                        <div class="w-auto pl-5 whitespace-no-wrap">
