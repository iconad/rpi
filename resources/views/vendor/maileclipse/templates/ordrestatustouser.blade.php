...
<table class="background" style="width: 100%;" border="0" width="100%" cellspacing="0" cellpadding="0" align="center">
<tbody>
<tr>
<td class="background" style="width: 100%;" align="center" valign="top" width="100%"><center>
...
<tr>
<td style="padding-bottom: 20px; background-color: #ffffff;" valign="top"><strong>Hi { Amir },</strong><br />Your order has been approved please, please go here to pay you payment. <a>contact support</a>.</td>
</tr>
<tr>
<td>
<table width="100%" cellspacing="0" cellpadding="0" bgcolor="#ffffff">
...
<div><!-- [if mso]>
                                    <v:rect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="#" style="height:40px;v-text-anchor:middle;width:200px;" stroke="f" fillcolor="#008000">
                                      <w:anchorlock/>
                                      <center>
                                    <![endif]--> <a style="background-color: #008000; color: #ffffff; display: inline-block; font-family: sans-serif; font-size: 18px; line-height: 40px; text-align: center; text-decoration: none; width: 200px; -webkit-text-size-adjust: none;" href="#">Account Settings</a> <!-- [if mso]>
                                      </center>
                                    </v:rect>
                                  <![endif]--></div>
</td>
