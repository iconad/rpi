...
<section class="categoryboxes md:px-10 md:px-7.5 ">
    <div class="flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-8 ">
        ...
        <div class="flex-shrink-0 w-full md:w-1/3 px-3 md:px-0 no-padding-mobile  ">
            <a href="https://printo.ae/categories/print-products"> <img src="{{ asset('images/home/printing.jpg') }}" alt="Image 1 " class="w-full h-auto "> </a>
        </div>

        <!-- Grid Box 2 -->
        <div class="flex-shrink-0 w-full md:w-1/3 px-3 md:px-0 no-padding-mobile  ">
            <a href="https://printo.ae/categories/packaging"> <img src="{{ asset('images/home/packaging.jpg') }}" alt="Image 2 " class="w-full h-auto "> </a>
        </div>

        <!-- Grid Box 3 -->
        <div class="flex-shrink-0 w-full md:w-1/3 px-3 md:px-0 no-padding-mobile  ">
            <a href="https://printo.ae/comingsoon"> <img src="{{ asset('images/home/merch.jpg') }}" alt="Image 3 " class="w-full h-auto ">
            </a>
        </div>
    </div>
</section>
...
<section class="md:p-5 p-7 md:px-12 bestseller">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-16">
        ...
        <div class="relative box">
            <a href="https://printo.ae/category/business-cards/products"><img src="{{ asset('images/home/product1.jpg') }}" alt="Product 1" class="box-image"></a>
            <div class="flex items-center justify-between mb-2 md:pt-6 pt-0.5">
                ...
                <div class="whatsapp-button">
                    ...
                    <a href="https://api.whatsapp.com/send?phone=971562876500&text=Iam%20intreasted%20in%20printo%20Services" class="whatsapp-text whatsapptext">WhatsApp Us</a>
                </div>
            </div>
        ...
        <!-- Box 2 -->
        <div class="relative box">
            <a href="https://printo.ae/category/large-stickers/products"><img src="{{ asset('images/home/product2.jpg') }}" alt="Product 2" class="box-image"></a>
            <div class="flex items-center justify-between mb-2 md:pt-6 pt-0.5">
        ...
        <!-- Box 3 -->
        <div class="relative box">
            <a href="https://printo.ae/category/posters/products"><img src="{{ asset('images/home/product3.jpg') }}" alt="Product 3" class="box-image"></a>
            <div class="flex items-center justify-between mb-2 md:pt-6 pt-0.5">
        ...
        <!-- Box 4 -->
        <div class="relative box">
            <a href="https://printo.ae/category/product/products"><img src="{{ asset('images/home/product4.jpg') }}" alt="Product 4" class="box-image"></a>
            <div class="flex items-center justify-between mb-2 md:pt-6 pt-0.5">
        ...
        <!-- Box 5 -->
        <div class="relative box">
            <a href="https://printo.ae/category/stationary-1/products"><img src="{{ asset('images/home/product5.jpg') }}" alt="Product 5" class="box-image"></a>
            <div class="flex items-center justify-between mb-2 md:pt-6 pt-0.5">
                <a href="https://printo.ae/category/stationary-1/products">
                    <p class="box-name">Desktop + Mob</p>
                </a>
                <div class="whatsapp-button">
                    <a href="#" class="whatsapp-icon">
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" class="whatsapptexticon" width="30" height="30" viewBox="0,0,256,256">
        ...
        <!-- Box 6 -->
        <div class="relative box">
            <a href="https://printo.ae/category/home-decor/subcategories/calendar/products"><img src="{{ asset('images/home/product6.jpg') }}" alt="Product 6" class="box-image"></a>
            <div class="flex items-center justify-between mb-2 md:pt-6 pt-0.5">
        ...
        <!-- Box 7 -->
        <div class="relative box">
            <a href="https://printo.ae/products/wallpapers/bedroom-wallpapers"><img src="{{ asset('images/home/product7.jpg') }}" alt="Product 7" class="box-image"></a>
            <div class="flex items-center justify-between mb-2 md:pt-6 pt-0.5">
        ...
        <!-- Box 8 -->
        <div class="relative box">
            <a href="https://printo.ae/category/roll-up-banners/products"><img src="{{ asset('images/home/product8.jpg') }}" alt="Product 8" class="box-image"></a>
            <div class="flex items-center justify-between mb-2 md:pt-6 pt-0.5">
        ...
        <!-- Box 9 -->
        <div class="relative box">
            <a href="https://printo.ae/category/foamboard-panels/products"><img src="{{ asset('images/home/product9.jpg') }}" alt="Product 9" class="box-image"></a>
            <div class="flex items-center justify-between mb-2 md:pt-6 pt-0.5">
        ...
        <section class="w-full md:w-2/5 bg-gray-200 p-6 pr-4 md:pr-24 mt-6 md:mt-0 md:ml-4 md:ml-8">
            <div class="flex flex-col h-full">
                <div>
                    ...
                    <a href="https://printo.ae/pages/about-us"> <button class="bg-black text-white text-base md:text-lg py-2 md:py-4 px-4 md:px-14 rounded-full self-start md:ml-4  md:mt-0">About
                            Us</button></a>
                </div>
            </div>
        </section>
...
<section class="toppicks md:p-5 p-7 md:px-12">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-14">
        ...
        <div class="flex flex-col items-start">
            <a href="https://printo.ae/comingsoon"> <img src="{{ asset('images/home/pick1.jpg') }}" alt="Product 1" class="w-full h-auto mb-2 md:mb-4"></a>
        ...
        <!-- Product 2 -->
        <div class="flex flex-col items-start">
            <a href="https://printo.ae/category/promotional-products/subcategories/hangers/products"> <img src="{{ asset('images/home/pick2.jpg') }}" alt="Product 2" class="w-full h-auto mb-2 md:mb-4"></a>
            <div class="flex items-center justify-between mb-2 w-full">
        ...
        <!-- Product 3 -->
        <div class="flex flex-col items-start">
            <a href="https://printo.ae/category/business-cards/products"><img src="{{ asset('images/home/pick3.jpg') }}" alt="Product 3" class="w-full h-auto mb-2 md:mb-4"></a>
            <div class="flex items-center justify-between mb-2 w-full">
                <a href="https://printo.ae/category/business-cards/products">
        ...
        <!-- Product 5 -->
        <div class="flex flex-col items-start">
            <a href="https://printo.ae/products/wallpapers/living-room-wallpapers"> <img src="{{ asset('images/home/pick5.jpg') }}" alt="Product 5" class="w-full h-auto mb-2 md:mb-4"></a>
            <div class="flex items-center justify-between mb-2 w-full">
        ...
        <!-- Product 6 -->
        <div class="flex flex-col items-start">
            <a href="https://printo.ae/products/wallpapers/canvas-frames"> <img src="{{ asset('images/home/pick6.jpg') }}" alt="Product 6" class="w-full h-auto mb-2 md:mb-4"></a>
            <div class="flex items-center justify-between mb-2 w-full">
...
<section class="faq flex flex-col md:flex-row p-0 md:p-12">
    ...
    <div class="w-full md:w-3/5 p-2 px-4 md:px-0 md:p-8">
        ...
        <div class="mb-4 md:mb-6 faqitems">
            <button class="faqbutton flex items-center justify-between w-full md:text-lg text-sm focus:outline-none border-b border-black pb-2 md:pb-6 px-4 md:px-6">
...
<section class="flex flex-col md:flex-row p-7 md:p-12">
    <div class="w-full md:w-1/2 h-screen/2 flex flex-col items-start justify-start relative md:pr-4">
        <a href="https://printo.ae/comingsoon"><img src="{{ asset('images/home/hot1.jpg') }}" alt="Image 1" class="w-full object-cover"></a>
    </div>
    <div class="w-full md:w-1/2 h-screen/2 py-6 md:py-0 flex flex-col md:pl-12">
        <!-- Desktop version layout -->
        <a href="https://printo.ae/comingsoon"><img src="{{ asset('images/home/hot2.jpg') }}" alt="Image 2" class="w-full object-cover md:mb-2 md:pb-4 hidden md:block"></a>
        <a href="https://printo.ae/comingsoon"><img src="{{ asset('images/home/hot3.jpg') }}" alt="Image 3" class="w-full object-cover md:pt-5 md:pt-4 hidden md:block"></a>

        <!-- Mobile version layout -->
        <div class="md:hidden w-full flex">
            <a href="https://printo.ae/comingsoon"><img src="{{ asset('images/home/hot2.jpg') }}" alt="Image 2" class="w-1/2 pr-3 object-cover" style=" width:100%; height: 150px;"></a>
            <a href="https://printo.ae/comingsoon"><img src="{{ asset('images/home/hot3.jpg') }}" alt="Image 3" class="w-1/2 pl-3 object-cover" style=" width:100%; height: 150px;"></a>
        </div>
    </div>
</section>
...
<section class="customerreviews">
    ...
    <section class="whatsappbanner relative px-0 md:px-0 py-8 md:py-16">
        <div class="h-auto text-white relative">
            <img src="{{ asset('images/home/whatsapp.jpg') }}" alt="whatsapp" class="mobilewhatsappimage w-full mb-8 md:max-w-none md:mb-0">
            <div class="absolute inset-0 flex flex-col items-center justify-center">
                <div class="text-center">
                    <p class="text-xs pt-6 md:pt-0 md:text-4xl lg:text-6xl font-bold leading-tight mb-3 md:mb-4 uppercase">
                    ...
                    <div class="hidden md:block py-4 md:py-8 lg:py-12 mx-auto" style="width: fit-content;">
                        <a href="https://api.whatsapp.com/send?phone=971562876500&text=Iam%20intreasted%20in%20printo%20Services" class="inline-block bg-white text-black md:px-10 lg:px-24 py-2 md:py-3 rounded-full flex items-center text-1-3rem letstalk">
                            Get in Touch
                    ...
                    <div class="md:hidden py-0 md:py-4 mx-auto" style="width: fit-content;">
                        <a href="https://api.whatsapp.com/send?phone=971562876500&text=Iam%20intreasted%20in%20printo%20Services" class="inline-block bg-white text-black px-6 py-0 md:py-2 rounded-full flex items-center text-base letstalk">
                            Get in Touch
                            <span class="ml-2 text-black">
                                <i class="fab fa-whatsapp"></i>
                            </span>
    ...
    <section class="p-5 md:p-16 newitems">
        ...
        <div class="grid grid-cols-1 grid-cols-2 md:grid-cols-4 gap-0 md:gap-6">
            <div class="p-2 flex flex-col md:items-center">
                <a href="https://printo.ae/comingsoon"><img src="{{ asset('images/home/newitem1.jpg') }}" alt="Image 1" class="w-full object-cover mb-2"></a>
                <a href="https://printo.ae/comingsoon">
            ...
            <div class="p-2 flex flex-col md:items-center">
                <a href="https://printo.ae/comingsoon"> <img src="{{ asset('images/home/newitem2.jpg') }}" alt="Image 2" class="w-full object-cover mb-2"></a>
                <a href="https://printo.ae/comingsoon">
            ...
            <div class="p-2 flex flex-col md:items-center">
                <a href="https://printo.ae/comingsoon"> <img src="{{ asset('images/home/newitem3.jpg') }}" alt="Image 3" class="w-full object-cover mb-2"></a>
                <a href="https://printo.ae/comingsoon">
            ...
            <div class="p-2 flex flex-col md:items-center">
                <a href="https://printo.ae/comingsoon"> <img src="{{ asset('images/home/newitem4.jpg') }}" alt="Image 4" class="w-full object-cover mb-2"></a>
                <a href="https://printo.ae/comingsoon">
