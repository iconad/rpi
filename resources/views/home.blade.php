    ...
    <div class="container mx-auto max-w-full flex flex-col md:flex-row md:p-4 p-0">
        ...
        <section class="w-full md:w-2/5 bg-gray-200 p-6 pr-4 md:pr-24 mt-6 md:mt-0 md:ml-4 md:ml-8">
            <div class="flex flex-col h-full">
                <div>
                    <h2 class="text-macbook text-2rem md:text-4xl mb-4 md:pr-26 md:pl-4 md:pt-24">
                        Premium
                        Design.<br class="">Premium Quality.</h2>


                    <p class="mb-4 md:pl-4 md:pt-4 md:pb-8 md:pr-26 md:mb-4 overflow-hidden md:h-[9rem]" style="line-height: 1.5rem;">With a keen focus on excellence, we transform your
                        ideas
                        into stunning visuals that captivate and resonate. Elevate your brand with
                        Printo, where
    ...
    <div class="w-full md:w-3/5 p-2 px-4 md:px-0 md:p-8">
        ...
        <div class="mb-4 md:mb-6 faqitems">
            <button class="faqbutton flex items-center justify-between w-full md:text-lg text-sm focus:outline-none border-b border-black pb-2 md:pb-6 px-4 md:px-6">
                <a href="your_arcadion_link_here" class="faqmobile md:pr-6">What are the types of
                    printers and
                    printing services offered by
                    Printo?</a>
                <span class="toggle-icon">+</span>
            </button>
            <p class="text-gray-600 answerfaq hidden">Printo stands as a preeminent printing press in
                the UAE,
                specializing in digital print solutions. Our expertise caters to diverse clientele
                including
                Public Relations, Global Brands, and Design Agencies.</p>
        </div>
        <div class="mb-4 md:mb-6 faqitems">
            <button class="faqbutton flex items-center justify-between w-full md:text-lg text-sm focus:outline-none border-b border-black pb-2 md:pb-6 px-4 md:px-6">
                <a href="your_arcadion_link_here" class="faqmobile md:pr-6">Are separate delivery
                    charges
                    applicable
                    to individual
                    products?</a>
            ...
            <p class="text-gray-600 answerfaq hidden">No, our streamlined shopping experience entails a
                singular
                delivery
                charge. You can consolidate multiple products within a single shopping cart, all covered
                by a
                fixed, unified delivery fee.</p>
        </div>
        <div class="mb-4 md:mb-6 faqitems">
            <button class="faqbutton flex items-center justify-between w-full md:text-lg text-sm focus:outline-none border-b border-black pb-2 md:pb-6 px-4 md:px-6">
                <a href="your_arcadion_link_here" class="faqmobile md:pr-6">Does Printo provide
                    international
                    shipping?</a>
                <span class="toggle-icon">+</span>
            </button>
            <p class="text-gray-600 answerfaq hidden">Certainly, Printo takes pride in its global reach!
                We
                extend our
                delivery services across the world, catering to the diverse printing needs of our
                clients.</p>
        </div>
        <div class="mb-4 md:mb-6 faqitems">
            <button class="faqbutton flex items-center justify-between w-full md:text-lg text-sm focus:outline-none border-b border-black pb-2 md:pb-6 px-4 md:px-6">
                <a href="your_arcadion_link_here" class="faqmobile md:pr-6">What is the turnaround time
                    for
                    Printo's
                    services?</a>
                <span class="toggle-icon">+</span>
            </button>
            <p class="text-gray-600 answerfaq hidden">The duration of service varies as each project
                possesses
                its unique
                characteristics. Some tasks can be promptly executed within minutes, while others may
                necessitate several days for completion. Inform us about your timeline requirements, and
                we will
        ...
        <div class="mb-4 md:mb-6 faqitems">
            <button class="faqbutton flex items-center justify-between w-full md:text-lg text-sm focus:outline-none border-b border-black pb-2 md:pb-6 px-4 md:px-6">
                <a href="your_arcadion_link_here" class="faqmobile md:pr-6">How can I place an order
                    with
                    Printo?</a>
                <span class="toggle-icon">+</span>
            </button>
            <p class="text-gray-600 answerfaq hidden">Initiating an order is a seamless process. Begin
                by
                selecting your
                preferred product, customizing options to your specifications, and indicating the
                desired
                quantity. From there, you have the choice to either "DESIGN IT" if you wish to embark on
                your
                design journey, or "UPLOAD your FILES" if you possess print-ready materials or would
                like to
                leverage the complimentary support of Printo's designers. Finally, complete the payment
                process
...
<section class="flex flex-col md:flex-row p-7 md:p-12">
    ...
    <div class="w-full md:w-1/2 h-screen/2 py-6 md:py-0 flex flex-col md:pl-12">
        ...
        <img src="{{ asset('images/home/hot2.jpg') }}" alt="Image 2" class="w-full object-cover md:mb-2 md:pb-4 hidden md:block">
        <img src="{{ asset('images/home/hot3.jpg') }}" alt="Image 3" class="w-full object-cover md:pt-5 md:pt-4 hidden md:block">

        <!-- Mobile version layout -->
        <div class="md:hidden w-full flex">
            <img src="{{ asset('images/home/hot2.jpg') }}" alt="Image 2" class="w-1/2 pr-3 object-cover" style=" height: 150px;">
            <img src="{{ asset('images/home/hot3.jpg') }}" alt="Image 3" class="w-1/2 pl-3 object-cover" style=" height: 150px;">
        </div>
    </div>
</section>
...
<section class="customerreviews">
    ...
    <section class="reviews-container">
        <div class="reviews-title text-lg md:text-4xl mb-4 ml-7 md:ml-12 py-8 mb-12">Hear From Our
            Customers
        </div>
            ...
            <div class="custom-swiper-container swiper-container">
                <div class="swiper-wrapper ml-7 md:ml-12">
                    ...
                    <div class="swiper-slide p-8 md:p-12 border-2 flex flex-col items-start">
                        ...
                        <p class="reviewsh mt-2">Excellent quality business cards - Affordable prices.
                        </p>
                    </div>
            ...
            <div class="absolute inset-0 flex flex-col items-center justify-center">
                <div class="text-center">
                    ...
                    <div class="md:hidden py-0 md:py-4 mx-auto" style="width: fit-content;">
                        <a href="#" class="inline-block bg-white text-black px-6 py-0 md:py-2 rounded-full flex items-center text-base letstalk">
                            Get in Touch
                            <span class="ml-2 text-black">
                                <i class="fab fa-whatsapp"></i>
                            </span>
