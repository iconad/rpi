    ...
    <div class="p-5 h-full bg-gray-100 rounded lg:flex items-center justify-between">
        <div class="sort w-full md:pr-12">
            <div class="text-xl font-semibold pb-2">
                <a href="/products/shirts/{{$subCategory->category->slug}}" class="theme-link hover:border-transparent text-sm text-gray-500">{{$subCategory->category->title}}</a> /
            ...
            <div class="font-semibold">
                <ul class="lg:flex items-center">
                    ...
                    <li class="w-auto mt-6 lg:mt-0 lg:pt-2 flex items-center justify-between">
                        ...
                        <form action="/products/shirts/{{$subCategory->category->slug}}/{{$subCategory->slug}}" method="get">
        ...
        <div class="search w-20rem flex items-center mt-5 lg:mt-0 lg:pb-5">
            ...
            <div class="w-full">
                ...
                <input type="search" value="@if(isset($_GET['search'])){{$_GET['search']}}@endif" placeholder="Search in {{$subCategory->title}} " class="w-full border-b border-gray-500  bg-transparent focus:outline-none" name="search" id="search">
                </form>
            </div>
        </div>
    </div>
