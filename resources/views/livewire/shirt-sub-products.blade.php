            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-5">
                ...
                <div>
                    ...
                    <div class="bg-gray-100 rounded-t-lg">
                        <a href="/product-order/shirt/{{$product->category->slug}}?subcategory={{$product->subcategory->id}}">
                    ...
                    <div class="flex items-center justify-around p-3 pt-0 border-2 border-t-0 border-l-0 border-r-0 border-sec" style="border-color: {{$borderColor}}">
                        <a href="/product-order/shirt/{{$product->category->slug}}?subcategory={{$product->subcategory->id}}" class="mr-auto theme-link text-base font-medium text-red-500 hover:border-transparent">Order Now</a>
                    </div>
                    </div>
                </div>
                @endforeach
