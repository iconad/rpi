        ...
        <div id="productSidebar" class=" {{ $isSidebar ? 'w-1/3' : 'hidden' }} ">
            <div class="mt-5 lg:m-5 ml-0 h-full rounded overflow-hidden">
                <div class="p-3 product-filter bg-gray-100">
                    ...
                    <form action="/products/personalized-gifts/{{$subcategory->slug}}" method="get">
                        @if(isset($_GET['sort']))
                        ...
                        @endif
                    {{-- <input type="text" name="arary" value="{{implode ("-", $selectedColors)}}"> --}}
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <div>
                    ...
                    <a href="/products/personalized-gifts/${product.subcategory.slug}">
                        ...
                        <thumb-image-blade classess="w-full" image="{{$product->getMedia('images')[0]->file_name}}" id="{{$product->getMedia('images')[0]->id}}"></thumb-image-blade>
                        @endif
                    </a>
                    <div class="p-3">
